        ...
        <>
          <div className="relative">
            <button
              ...
              className="fixed right-2 bottom-4 z-50 bi-cart-fill font-poppins btn-bg shadow text-xl text-white rounded-full p-0 w-12 h-12"
            >
          ...
          {viewCart && (
            <div className="secondary-bg shadow shadow-teal-500 w-[98%] h-[100%] fixed top-0 right-0  z-50">
                    ...
                    <div className="col-span-4">
                      <div className="flex gap-x-2 h-full items-center">
                        <input
                          ...
                          value={c.quantity}
                          onChange={(e) =>
                            handleQuantityChange(c.id, parseInt(e.target.value))
                          }
                        />
                      </div>
                    </div>
