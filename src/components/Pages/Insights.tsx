        ...
        <div className="grid grid-cols-5 gap-x-5">
          ...
          <div className="col-span-3">
            <div className="grid grid-cols-3 p-5 gap-x-5">
              {/* Card Views */}
              <div className="w-full shadow rounded-xl px-5 py-4">
              ...
              {/* Link Taps */}
              <div className="col-span-3 shadow rounded mt-5 p-4">
                <div className="grid grid-cols-4">
                  <div>
                    <h1 className="text-sm text-gray-500">Link</h1>
                  </div>
                  <div>
                    <h1 className="text-sm text-gray-500">Name</h1>
                  </div>
                  <div>
                    <h1 className="text-sm text-gray-500">Job</h1>
                  </div>
                  <div>
                    <h1 className="text-sm text-gray-500">Taps</h1>
                  </div>
                </div>
              </div>
            </div>
