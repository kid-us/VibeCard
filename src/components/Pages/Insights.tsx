  ...
  return (
    <>
      ...
      <div className="px-6 mt-5">
        <div className="grid grid-cols-5 gap-x-5 secondary-bg rounded">
          <div className="col-span-2"></div>
          <div className="col-span-3">
            <div className="grid grid-cols-3 p-5 gap-x-5">
              {/* Card Views */}
              <div className="w-full shadow shadow-gray-600 rounded px-5 py-4 text-white secondary-bg">
              ...
              {/* Link Taps */}
              <div className="col-span-3 shadow shadow-gray-600 rounded mt-5 p-4">
