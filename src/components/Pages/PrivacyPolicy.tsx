    ...
    <>
      ...
      <div className="container mx-auto mt-10">
        <div className="text-white lg:px-0 px-3">
          ...
          <p className="text-lg">
            VibeCard is committed to protecting and respecting the privacy of
            its users. Our privacy practices comply with the European General
            Data Protection Regulation (GDPR). We only collect personal data
            necessary for the delivery of our services and retain this data only
            as long as is required by law or necessary for the purposes for
            which it is processed. Users have the right to access their stored
          ...
          <p className="text-lg">
            ...
            terms and conditions. By using our services, you agree to these
            terms. Unauthorized use of our products for illegal purposes is
            prohibited. In the case of misuse, we reserve the right to suspend
            service and take legal action.
          </p>
          ...
          <p className="text-lg">
            ...
            directly or indirectly from the use of our products or services.
            While we strive to ensure that all information provided on our
            website is accurate, we do not guarantee its completeness or
            accuracy.
          </p>
          <h1 className="my-5 text-xl font-extrabold">
          ...
          <p className="text-lg">
            We reserve the right to change our legal notices at any time.
            Changes will be posted on our website and become effective upon
            posting. Users are encouraged to regularly review the legal notices
