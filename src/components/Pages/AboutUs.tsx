    ...
    <>
      ...
      <div className="container mx-auto">
        <div className=" mt-10 text-white lg:px-0 px-3">
          ...
          <p className="text-lg">
            VibeCard was founded in 2023 in Emmendingen, Germany, with the
            vision to revolutionize how people exchange professional and
            personal information. As a newly established company, we are
            determined to take a leading role in the technology sector and
            redefine communication in the professional world.
          </p>
          <h1 className="my-5 text-xl font-extrabold">
            First Steps Towards a Great Future
          </h1>
          <p className="text-lg">
            Our journey began with the realization that traditional business
            cards are often inefficient and environmentally harmful. To address
            this issue, we developed an innovative NFC-based solution that
            allows for the quick, secure, and waste-free exchange of contacts.
            From the outset, our goal has been not only to offer an alternative
            but to significantly improve upon traditional methods.
          </p>
          ...
          <p className="text-lg">
            ...
            satisfaction, security, and design quality, we strive to make
            VibeCard the first choice for digital business communication.
          </p>
          <h1 className="my-5 text-xl font-extrabold">
