    ...
    <>
      ...
      <div className="container mx-auto lg:mt-20 mt-5 secondary-bg shadow-lg shadow-gray-400 rounded overflow-hidden">
        <div className="lg:grid grid-cols-2 justify-between gap-x-10">
          <div className="mt-10 lg:mx-0 mx-1 px-20 pb-10">
            <Card textColor={metalBg.color} bg={metalBg.bg} />
          </div>

          <div className=" px-2 bg-white ps-10">
            <div className="mt-4 rounded-xl px-3 py-5">
              <p className="text-4xl text-black">
                Vibecard{" "}
                <span className="text-teal-400 font-extrabold">Metal</span> Card
              </p>
              <p className="text-black font-poppins mt-5 text-2xl">Price €35</p>
            ...
            {/*Quantity */}
            <p className="mt-5 mb-4">Quantity</p>
